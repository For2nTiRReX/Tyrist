...
var HotelCommentsFormComponent = (function () {
    ...
    HotelCommentsFormComponent.prototype.addComment = function () {
        ...
        if (this.commentForm.valid) {
            var hotelId = this.activatedRoute.snapshot.params["id"];
            var newComment = new Comment_1.Comment(null, hotelId, this.commentForm.get('comment').value, this.commentForm.get('name').value, this.getCurrentDate(), 1);
            console.log(newComment);
            if (this._commentsService.addComment(newComment)) {
...
HotelCommentsFormComponent = __decorate([
    ...
    __metadata("design:paramtypes", [forms_1.FormBuilder, comments_service_1.CommentsService, router_1.ActivatedRoute])
